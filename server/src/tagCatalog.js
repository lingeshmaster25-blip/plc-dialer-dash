/**
 * Tag catalog — AUTO-SYNCED with src/lib/tag-catalog.ts (the client mirror).
 * Both files MUST list the same names + addresses, because the client writes
 * tags by NAME and this server resolves them to PLC addresses. If a tag the UI
 * writes is missing here, /write returns 404 and the client silently falls back
 * to simulation — which is the bug that stopped bin calls reaching the PLC.
 *
 * Address syntax (TIA Portal):
 *   I0.x / Q0.x / M0.x  — single bit
 *   MWxx                — 16-bit word in M area
 *   DB<n>.DBWxx         — 16-bit word (INT) in DB<n>
 *   DB<n>.DBDxx         — 32-bit dword (REAL) in DB<n>
 */

const TAGS = [
  { name: "Bin_Call",                address: "M0.0",       group: "Force Buttons",        type: "bool" },
  ...
  { name: "Tray_Call",               address: "M0.6",       group: "Force Buttons",        type: "bool" },
  { name: "Bin_Return_Home",         address: "M6.0",       group: "Force Buttons",        type: "bool" },
  { name: "Tray_Return_Home",        address: "M0.7",       group: "Force Buttons",        type: "bool" },
  { name: "Emergency_Stop_CMD",      address: "M5.5",       group: "Force Buttons",        type: "bool" },
  ...
  { name: "Over_load",               address: "M8.0",       group: "Alarms",               type: "bool" },
  { name: "Bin_over_Height",         address: "M8.1",       group: "Alarms",               type: "bool" },
  { name: "Tray_Misalignment",       address: "M2.3",       group: "Alarms",               type: "bool" },
  { name: "Maintenance_Store_Open",  address: "M7.2",       group: "Alarms",               type: "bool" },
  ...
  { name: "Extractor_Misalignment",  address: "M6.6",       group: "Alarms",               type: "bool" },
  { name: "Emergency_Stop",          address: "I3.5",       group: "Alarms",               type: "bool" },
